    ...
    try {
      for (let index in body.promos) {
        ...
        if (parseInt(ver[1]) <= 1 && parseInt(ver[2]) <= 5) {
          ...
          item["filename"] = "forge-{0}-{1}-{0}-installer.jar".format(
            mcver,
            forgever,
          );
          item["url"] =
          ...
          item["url"] =
            "http://files.minecraftforge.net/maven/net/minecraftforge/forge/{0}-{1}-{0}/{2}".format(
              mcver,
              forgever,
              item["filename"],
            );
          ...
          item["filename"] = "forge-{0}-{1}-installer.jar".format(
            mcver,
            forgever,
          );
          item["url"] =
            "http://files.minecraftforge.net/maven/net/minecraftforge/forge/{0}-{1}/{2}".format(
              mcver,
              forgever,
              item["filename"],
            );
