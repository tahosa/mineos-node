  ...
  profile: {
    ...
    handler: (profile_dir, callback) => {
      ...
      try {
        ...
        item['url'] =
          'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.18.32.02.zip';
        p.push(JSON.parse(JSON.stringify(item)));
        ...
        item['url'] =
          'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.18.31.04.zip';
        p.push(JSON.parse(JSON.stringify(item)));
        ...
        item['url'] =
          'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.18.30.04.zip';
        p.push(JSON.parse(JSON.stringify(item)));
        ...
        item['url'] =
          'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.12.1.1.zip';
        p.push(JSON.parse(JSON.stringify(item)));
    ...
    postdownload: (profile_dir, dest_filepath, callback) => {
      ...
      fs.chmod(profile_dir + '/bedrock_server', 0o755);
      callback();
    },
  },
};
